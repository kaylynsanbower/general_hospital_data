...
## Set file paths
########################################################################################
patpath.raw="~/Dropbox/Research-Projects/general_hospital_data/HCRIS/data/input/HCRIS_v2010/"
...
hcris.vars = rbind(hcris.vars,c('tot_uncomp_care_charges','S100000','02000','00300','numeric')) # new
hcris.vars = rbind(hcris.vars,c('tot_uncomp_care_partial_pmts','S100000','02200','00300','numeric')) # new
hcris.vars = rbind(hcris.vars,c('bad_debt','S100000','02600','00100','numeric')) # new
hcris.vars = rbind(hcris.vars,c('cost_to_charge','S100000','00100','00100','numeric')) # new 

hcris.vars = rbind(hcris.vars,c('new_cap_ass','A700001','01000','00200','numeric')) # new 

hcris.vars = rbind(hcris.vars,c('cash','G000000','00100','00100','numeric')) # new 

hcris.vars = rbind(hcris.vars,c('tot_pat_rev','G300000','00100','00100','numeric')) # new
hcris.vars = rbind(hcris.vars,c('allowance','G300000','00200','00100','numeric')) # new
hcris.vars = rbind(hcris.vars,c('net_pat_rev','G300000','00300','00100','numeric')) # new 
