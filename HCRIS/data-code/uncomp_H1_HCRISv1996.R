########################################################################################
## Author:        Ian McCarthy (adapted by Kaylyn Sanbower)
## Date Created:  5/29/2019
## Date Edited:   2/21/2022
...
## Set file paths
########################################################################################
path.raw="/Users/kaylynsanbower/Dropbox/Data-Public_Access/HCRIS/data/HCRIS_v1996"
...
## Variables for inpatient charges amount
...
# uncompensated care
hcris.vars = rbind(hcris.vars,c('uncomp_care','S100000','03000','0100','numeric')) # new
hcris.vars = rbind(hcris.vars,c('cost_to_charge','S100000','02400','0100','numeric')) # new 

# capex
hcris.vars = rbind(hcris.vars,c('new_cap_ass','A700002','00900','0200','numeric')) # new

# cash on hand 
hcris.vars = rbind(hcris.vars,c('cash','G000000','00100','0100','numeric')) # new

# revenue variables
hcris.vars = rbind(hcris.vars,c('tot_pat_rev','G300000','00100','0100','numeric')) # new
hcris.vars = rbind(hcris.vars,c('allowance','G300000','00200','0100','numeric')) # new
hcris.vars = rbind(hcris.vars,c('net_pat_rev','G300000','00300','0100','numeric')) # new
...
for (i in 2005:2011) {
  ...
  if (i==2005) {
    final.hcris.v1996=final.reports.2005
  } else {
