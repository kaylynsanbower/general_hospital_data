...
path.code="~/Dropbox/Research-Projects/general_hospital_data/HCRIS/data-code/"
path.data="~/Dropbox/Research-Projects/general_hospital_data/HCRIS/data/input/"
path.dout="~/Dropbox/Research-Projects/general_hospital_data/HCRIS/data/output/"
...
write_tsv(final.hcris.data,file=paste(path.dout,"/HCRIS_Data_thru2019.txt",sep=""),append=FALSE,col_names=TRUE)